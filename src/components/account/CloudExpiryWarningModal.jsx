      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 14px', fontSize: 13.5, color: 'var(--text-muted)', lineHeight: 1.6 }}>
          {desktopApp
            ...
            : "When it ends, your web account falls back to Free cloud limits (one editable project, 250 MB) until you renew Cloud Mode. YOW does not delete projects as part of this plan change, but this is a good time to download a full backup."}
        </p>
