  ...
  // ── AI tools ──
  {
    ...
    features: [
      ...
      },
      {
        ...
        ttrpg: true,
        dnd: true,
        note: 'Link your own account from a provider like ChatGPT, Claude, OpenRouter, or Google AI, right from Account Settings. You pay that provider directly for what you use — YOW never marks up or resells AI usage.',
      },
    ],
  },
