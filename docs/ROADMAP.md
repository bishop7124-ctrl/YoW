...
| 2026-07-19 QA: internal linking unlink/reverse references unreliable | Worldbuilding reliability issue. Links between characters, lore, locations, timeline, and history did not consistently unlink from both sides. | Confirmed | Review world link utilities and all edit forms; ensure outgoing and incoming references update atomically and display/navigation chips remain accurate after unlink/delete. | Blocks the internal-linking conditional row if launch copy relies on cross-references. |
